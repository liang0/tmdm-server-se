...
public class BulkUpdateTabPanel extends TabPanel {

    private static BulkUpdateTabPanel instance;
    ...
    public static BulkUpdateTabPanel getInstance() {
        if (instance == null) {
            instance = new BulkUpdateTabPanel();
        }
        return instance;
    }

    private BulkUpdateTabPanel() {
